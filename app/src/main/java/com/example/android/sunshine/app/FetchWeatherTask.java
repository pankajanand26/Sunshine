...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor row = mContext.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
        ...
        if(row.moveToFirst()){
            int locationIndex = row.getColumnIndex(WeatherContract.LocationEntry._ID);
            locationID = row.getLong(locationIndex);
        }
        else{
...
//        String units = "metric";
        ...
        Log.d(LOG_TAG,"Units are in " + units);
        int numDays = 14;
